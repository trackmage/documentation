...
See <a href="/docs/before-start#obtain-authorization-token" title="Before Start - Obtain Authorization TOKEN">Before Start</a> for instructions on obtaining store API credentials and TOKEN.

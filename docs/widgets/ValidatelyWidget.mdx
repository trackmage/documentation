---
id: ValidatelyWidget
title: Validately Widget
sidebar_label: Validately Widget
slug: validately-widgets.html
---

## Introduction

<p>In this article we will look at configure, usage and troubleshooting of <strong>Validately Widget</strong>.</p>
<p>TrackMage provides the opportunity to validate your customers' emails on your store website using the <strong>Validately</strong> widget.</p>
...
<p>Before configure validately widget please go to widgets page and add new Validately widget:</p>

### Add Validately widget in your TrackMage account

- Go to widgets page

![Go To Widgets Page](../../src/img/validately-widget/to-widgets-page.png)

- Add new Validately Widget

![Add New Widget](../../src/img/validately-widget/new-widget.png)
...
![Widget Options](../../src/img/validately-widget/widget-options.png)
...
![Copy Widget Code](../../src/img/validately-widget/copy-code.png)
...
```javascript
<script type="text/javascript" src="https://api.trackmage.com/validately.js"></script>
<script>
    window.ValidatelyDOMContentLoaded(function() {
        ...
        inputs.forEach(input => window.Validately({input, validationMessage, suggestionTemplate, widgetId}));
    })
</script>
```
...
![Paste Widget Code](../../src/img/validately-widget/paste-to-wp.png)

Finally, please test the work of widget on your page.

![Result of Widget Work](../../src/img/validately-widget/result-success.png)

![Result of Widget Work With Error](../../src/img/validately-widget/result-with-error.png)
...
You will be able to see validately errors:

![Validately Error](../../src/img/validately-widget/error.png)

Below we will review common errors and ways to solve them.

### Wrong Domain

Error message looks like **Domain is not allowed to use Validately widget with ID: {$widgetId}**

**Solution:** please go to your widget's settings page and check the **Domain** field contains correct domain name.

### Wrong Widget ID or Widget ID is corresponding not to Validately Widget

Error message looks like **Validately widget with ID {$widgetId} was not found**
...
Error message looks like **Validately widget is disabled. Please enable it before use.**

**Solution:** please go to your widget page and enable widget.

![Enable Widget](../../src/img/validately-widget/enable-widget.png)
